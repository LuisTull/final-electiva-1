...
- documentacion detallada (README + guias)

## 8. Nota importante

En este entorno de trabajo no se encontro `node` ni `npm` instalados, por lo que no fue posible ejecutar localmente lint/tests/build desde la terminal actual. El proyecto queda listo para correr en cualquier entorno con Node o Docker disponibles.
